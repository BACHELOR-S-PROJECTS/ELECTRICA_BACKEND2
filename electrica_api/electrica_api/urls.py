...
urlpatterns = [ #1 = bien, #2= mal, #3= tiene permiso, #4= no requiere permisos
    ...
    path('core/user/publicidad/view',
        views.get_all_commerces),  
    path('core/factura/view/id',views.obtainListFactura),
    path('core/globales/create',views.CreateGlobal.as_view()),
    path('core/globales/view',views.get_all_global_vars),
    path('core/globales/view/<str:val>/',views.get_put_one_global_vars),
    path('core/globales/delete/<str:val>/',views.del_global_var),
    path('core/client/status',views.get_financial_status),
]
